  ...
  <body>
    ...
    <main class="main">
            ...
            <div class="reviews__container grid">
              <div class="review__single">
                ...
                <div class="review__data">
                  ...
                  <p class="review__description">Thank you very fast shipping from Poland only 3 days.</p>
              ...
              <div class="review__single">
                <div>
                  <img src="assets/image/circle-user.png" alt="" class="review__img">
                  <h4 class="review__title">Novan</h4>
                </div>
              ...
              <div class="review__single">
                <div>
                  <img src="assets/image/circle-user.png" alt="" class="review__img">
                  <h4 class="review__title">Raka</h4>
                </div>
      ...
      <section class="products container section--lg">
        ...
        <?php $no=1; foreach($related as $value){?>
